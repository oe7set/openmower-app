...
function fixTypeLabel(
  ...
  switch (t) {
    case 5:
      return {label: 'RTK Fixed', color: 'success'};
    case 4:
      return {label: 'RTK Float', color: 'warning'};
    case 3:
      return {label: 'DGPS', color: 'warning'};
    case 2:
      return {label: '3D Fix', color: 'warning'};
    case 1:
      return {label: '2D Fix', color: 'error'};
    case 0:
    default:
      return {label: 'No Fix', color: 'error'};
  }
}
...
export default function GpsCard() {
  ...
  return (
    <Card sx={{...outerCardStyles(theme), flex: '1 1 280px', minWidth: 0}}>
      <CardActionArea onClick={() => router.push('/gnss')} sx={{height: '100%'}}>
        <CardContent>
          ...
          <Box
            sx={{
              ...
              gap: 2,
              mb: sats !== undefined || pdop !== undefined ? 1.5 : 0,
            }}
          >
            <Box>
            ...
            <Box sx={{textAlign: 'right'}}>
              ...
              <Typography variant="body2" fontWeight="600" color={headingValid ? 'text.primary' : 'text.secondary'}>
