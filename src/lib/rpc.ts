...
/**
 *
 * Whether a smart BMS has reported (per-cell / capacity / cycle data is then available).
 *
 */
export type BooleanGY1YGAQX = boolean;
/**
 *
 * Wall-clock epoch milliseconds of the underlying message.
 *
 */
export type IntegerLl43XteV = number;
/**
 *
 * Pack voltage in V.
 *
 */
export type NumberSbmy0Hlm = number;
/**
 *
 * Pack current in A (positive = discharge).
 *
 */
export type NumberO8CMwOVI = number;
/**
 *
 * State of charge 0..1 relative to full-charge capacity.
 *
 */
export type NumberPcYMc14F = number;
/**
 *
 * Remaining capacity in Ah.
 *
 */
export type NumberR1BKJDKm = number;
/**
 *
 * Current full-charge capacity in Ah (wear indicator).
 *
 */
export type NumberWXpun23Q = number;
/**
 *
 * Charge cycles.
 *
 */
export type Integer3JSZpQWP = number;
/**
 *
 * Pack temperature in degrees Celsius.
 *
 */
export type NumberFbo3E8M7 = number;
/**
 *
 * Human-readable comma-joined status/alarm flags.
 *
 */
export type StringR2T0WyHw = string;
/**
 *
 * State of charge 0..1 relative to design capacity (State-of-Health hint).
 *
 */
export type NumberCZmoynbX = number;
/**
 *
 * Per-cell voltages in V.
 *
 */
export type UnorderedSetOfNumberHo1ClIqDjVFUi4Fb = NumberHo1ClIqD[];
/**
 *
 * Charger output voltage in V.
 *
 */
export type NumberCSFXHyEr = number;
/**
 *
 * Charge current in A.
 *
 */
export type NumberNGMPgmpm = number;
/**
 *
 * Battery voltage as read by the charger IC in V.
 *
 */
export type NumberBzFwrkZO = number;
/**
 *
 * Charger-computed battery percentage 0..1.
 *
 */
export type NumberS438Uo9O = number;
/**
 *
 * Human-readable charger state.
 *
 */
export type String8JiDS0Ts = string;
/**
 *
 * DC-DC converter input current in A.
 *
 */
export type NumberB83VrfPw = number;
/**
 *
 * Charger input current from the wall in A.
 *
 */
export type NumberX685WFAD = number;
/**
 *
 * Epoch seconds.
 *
...
/**
 *
 * Merged battery + charger snapshot. `present` is true only when a smart BMS has reported. All other fields are optional and absent when the source does not provide them.
 *
 */
export interface  {
  present: BooleanGY1YGAQX;
  ts_ms?: IntegerLl43XteV;
  voltage?: NumberSbmy0Hlm;
  current?: NumberO8CMwOVI;
  relative_state_of_charge?: NumberPcYMc14F;
  remaining_capacity?: NumberR1BKJDKm;
  full_charge_capacity?: NumberWXpun23Q;
  cycle_count?: Integer3JSZpQWP;
  temperature?: NumberFbo3E8M7;
  battery_status?: StringR2T0WyHw;
  mfr_name?: StringDoaGddGA;
  mfr_date?: StringPlNnRm6U;
  dev_name?: StringDoaGddGA;
  dev_version?: StringDoaGddGA;
  dev_chemistry?: StringDoaGddGA;
  serial_number?: Integer2AHOqbcQ;
  design_capacity_ah?: NumberHo1ClIqD;
  design_voltage_v?: NumberHo1ClIqD;
  absolute_soc?: NumberCZmoynbX;
  cell_count?: Integer2AHOqbcQ;
  cell_voltage_v?: UnorderedSetOfNumberHo1ClIqDjVFUi4Fb;
  charge_voltage?: NumberCSFXHyEr;
  charge_current?: NumberNGMPgmpm;
  battery_voltage?: NumberBzFwrkZO;
  battery_pct?: NumberS438Uo9O;
  charger_status?: String8JiDS0Ts;
  charger_enabled?: BooleanVyG3AETh;
  dcdc_input_current?: NumberB83VrfPw;
  charger_input_current?: NumberX685WFAD;
  [k: string]: any;
}
 ...
 *
 */
export type  = ObjectHAgrRKSz | Integer7Bd9WOt2 | UnorderedSetOfUnorderedSetOfNumberHo1ClIqDVeKFvh2CtSFAhUUG | UnorderedSetOfUnorderedSetOfUnorderedSetOfNumberHo1ClIqDVeKFvh2CtSFAhUUGv0X1LEW3 | NumberHo1ClIqD | BooleanVyG3AETh | UnorderedSetOfInteger7Bd9WOt2MMEUfR9Y | ObjectOfNumberUQNyT7MlNumberTAZyBWjPStringCakJguo4IntegerMe5ZzgZONumberA4WF8D4DGSirr8SK | ObjectIZgu6KjQ | UnorderedSetOfStringDoaGddGADvj0XlFa | StringDoaGddGA | AnyL9Fw4VUO |  | IntegerOmVsfaNv | ObjectOfStringTF2N8PAYStringW73LspcZStringPIVdEUDGUnorderedSetOfStringDoaGddGAxIQucMbfUnorderedSetOfObjectOfStringKjcr2O6HStringLfutBJWhUnorderedSetOfStringLD1FOTDsBUsnf7JHF8EEHH5UANpB27CbYGRFtjes | String8MpEGeOy | IntegerQDdWfSg7 | StringYKWJZZDp | IntegerGCqMpUyL | IntegerN0RpaiaM | StringIQ4UVKQj | IntegerVGvI61Gh | StringZDJW5SIj | NullQu0Arl1F | ObjectOfUnorderedSetOfObjectOfUnorderedSetOfUnorderedSetOfNumberHo1ClIqDVeKFvh2CtSFAhUUGBooleanVyG3AEThPwv5XVVFOVt11FmXBooleanVyG3AEThXQSuYyPu | ObjectOfBooleanVyG3AEThIj5UHSfl | ObjectOfStringDoaGddGAPbK8LLpM | ObjectHicl3T4F | ObjectBd6DQSjJ | ObjectOfUnorderedSetOfStringDoaGddGADvj0XlFaInteger2AHOqbcQUnorderedSetOfObjectOfString9BJAV6BuStringDoaGddGASkKJ8ODFGua3KoaTAuVjlbwB | ObjectOfObjectIZgu6KjQ48UMYEZj |  | UnorderedSetOfObjectOfStringVpQXKS8ZStringVgJsWAxbStringDoaGddGAStringEfOF2TabStringMVRSI8C0StringB7N8MIyAStringIgmTLAHJStringUlYO7V8FUnorderedSetOfInteger2AHOqbcQarZIQlOyLR2TletX3XU5XiEl | ObjectOfUnorderedSetOfObjectOfString9Bg2HXX5StringPlNnRm6UBu0O08MRASXjv8PuDgvnw6C1 | ObjectOfBooleanVyG3AEThInteger2AHOqbcQIQdazwvG | ObjectOfNumberHo1ClIqDInteger2AHOqbcQInteger2AHOqbcQInteger2AHOqbcQInteger2AHOqbcQIntegerPspRrr78Integer2AHOqbcQNumberU8K1Uas0NumberP4YjumIFE1QlmvON |  | ObjectOfInteger2AHOqbcQStringDoaGddGABooleanVyG3AEThWJ46RKI7 | ObjectOfUnorderedSetOfObjectOfNumberCxGOTzvBStringDoaGddGAStringDoaGddGAStringSkVxiS6EYfecu46YPnkCtRjyCwlY525N | ObjectOfUnorderedSetOfObjectOfNumberCxGOTzvBInteger2AHOqbcQStringDoaGddGAInteger2AHOqbcQNumberHo1ClIqDNumberHo1ClIqDQ1YTyTgxEuFQMiZQWVpN69Fd |  | ObjectOfInteger2AHOqbcQNumberHo1ClIqDNumberHo1ClIqDUnorderedSetOfNumberHo1ClIqDC9YO3FZRObjectOfNumberHo1ClIqDNumberHo1ClIqDNumberHo1ClIqDBYn6PexVUnorderedSetOfNumberHo1ClIqDC9YO3FZRKRBICRb2 | ObjectOfInteger2AHOqbcQUnorderedSetOfObjectOfStringDLUYbyEJIntegerRGdkPNscString836AVxQgStringVd3W2HD3StringIQ4UVKQjString3RwRKkvGObjectWKqX2MzRBooleanC0TIr4AuJMUDeaEERCDBF6Ob2Ihe7M12 | ObjectOfStringDoaGddGAUnorderedSetOfObjectOfNumberHo1ClIqDIntegerSAdpLmxWX6TdOslv3Y9GQJtaGs9BtQ5U | ObjectOfObject8Zf4CCW24GqovvrD;
...
export class OpenMowerRpc extends OpenMowerBaseRpc {
  ...
  battery = {
    /**
    * Latest cached BMS + charger telemetry snapshot (per-cell voltages, current, capacity, cycles, temperature, charger state). Mirrors the live <prefix>bms/json topic.
    */
    get_telemetry: async (timeoutMs?: number): Promise<> => this.call('battery.get_telemetry', undefined, timeoutMs),
  };
  logs = {
    /**
