...
import {
  ...
  RotateRight as ImuIcon,
  SatelliteAlt as GnssIcon,
  Sensors as SensorIcon,
  Settings as SettingsIcon,
  Smartphone as PilotIcon,
...
export function createNavigationItems(): NavigationItem[] {
  return [
    ...
    {label: 'Pilot', icon: <PilotIcon />, path: '/pilot', isGlobal: false},
    ...
    {label: 'GNSS', icon: <GnssIcon />, path: '/gnss', isGlobal: false},
